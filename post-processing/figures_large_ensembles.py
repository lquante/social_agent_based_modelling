...
file_uniform = os.path.join(datadir, "uniform_self_reliance_ensembles/agent_data_1000steps.csv") #TODO: adjust
...
for sigma in sigma_values:
    for gamma in gamma_means:
        gamma_files[format(gamma, ".2f"), format(sigma, ".3f")] = os.path.join(datadir,
                                                                               ensemble,"agent_data_normal-self_reliance_mu-" + format(
